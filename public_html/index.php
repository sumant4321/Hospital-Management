...
-->             <div class="nav-wrapper">
            ...
            <div class="app-btn">
            <a href="appointment.php" class="z-depth-5" style="padding:12px;border-radius:5px;background: linear-gradient(to right, #01074c, #1babd7);color:white;font-size:20px;text-decoration:none;font-family:  'Caladea', serif;"> Book Appointment Now <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>        
        </div>
    </div>
